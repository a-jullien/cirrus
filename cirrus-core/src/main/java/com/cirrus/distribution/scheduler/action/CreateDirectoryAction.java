...
public class CreateDirectoryAction extends AbstractAction<ICirrusMetaData> {

    //==================================================================================================================
    // Constructors
    //==================================================================================================================
    public CreateDirectoryAction() {
        super(ActionType.CREATE_DIRECTORY);
    }
    ...
    @Override
    public ICirrusMetaData call() throws Exception {
        return null;
    }
}
